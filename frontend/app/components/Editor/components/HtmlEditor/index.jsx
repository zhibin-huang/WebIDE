...
const PreviewEditor = observer(({ url, state }) => (
  <div className="preview-iframe">
    <iframe src={url} />
    {state.isResizing && <div className="preview-iframe-msk" /> }
  </div>
));
...
const ResizeBar = ({
  parentFlexDirection, sectionId, startResize, actions, state,
}) => {
...
class HtmlEditor extends Component {
  ...
  render() {
    ...
    const {
      leftGrow, rightGrow, showBigSize, showPreview, previewUniqueId,
    } = tab;
