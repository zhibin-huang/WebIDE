...
const EditorWrapper = observer(({ tab, active }) => {
  ...
  switch (editorType) {
    case 'htmlEditor':
      return React.createElement(HtmlEditor, {
        editor, key, tab, active,
      });
    case 'default':
      return React.createElement(MEditor, {
        editor, key, tab, active,
      });
    ...
    case 'imageEditor':
      return React.createElement(ImageEditor, {
        path: file.path, key, tab, active,
      });
    default:
      return React.createElement(UnknownEditor, {
        path: file.path, size: file.size, key, tab, active,
      });
  }
});
