...
const TextCell = ({
  rowIndex, data, columnKey, selectedRow, onContextMenu, ...props
}) => (
  <Cell
    {...props}
...
class History extends Component {
  ...
  renderCell(selectedRow, cellData, cellDataKey, rowData, rowIndex, columnData, width) {
    return (
      <div
        onContextMenu={((_this) => (e) => (_this._onRowContextMenu(e, rowIndex, rowData)))(this)}
        className={cx({ selected: rowIndex === selectedRow })}
      >
        cellData
      </div>
