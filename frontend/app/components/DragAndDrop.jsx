...
class DragAndDrop extends Component {
  ...
  render() {
    ...
    return meta && meta.paneLayoutOverlay
      ? <div className="pane-layout-overlay" style={overlayStyle} />
      : null;
  }
  ...
  onDrop = (e) => {
    ...
    switch (`${source.type}_on_${target.type}`) {
      case 'TAB_on_PANE':
        PaneActions.splitTo(target.id, meta.paneSplitDirection).then((newPaneId) => TabActions.moveTabToPane(source.id, newPaneId));
        break;
